...
export default class UpdateNameDialog extends Component<Props, State> {
  state: State = {
    open: false,
    loading: false,
    value: "",
  ...
  handleSubmitted = (value: string) => {
    ...
    EventEmitter.emit("plot-name-update", payload);
  ...
  componentDidMount() {
    EventEmitter.on(
      "plot-name-updated-success",
      this.handleUpdateSuccess
    );
    EventEmitter.on(
      "plot-name-updated-failure",
